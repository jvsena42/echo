...
import com.github.jvsena42.echo.data.pubky.SrsStateDto
...
import com.github.jvsena42.echo.domain.model.isDue
...
class SrsRepositoryImpl(
    ...
    private suspend fun fetchState(deckId: String, cardId: String): SrsState? {
        ...
        return pubky.get(PubkyPaths.srs(author, deckId, cardId))
            .mapCatching { echoJson.decodeFromString<SrsStateDto>(it).toDomain() }
