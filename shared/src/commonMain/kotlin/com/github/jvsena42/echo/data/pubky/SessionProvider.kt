 ...
 * against the homeserver without depending on [com.github.jvsena42.echo.data.repository.IdentityRepository]
...
/**
 * Mutable hot cell for the active session. Hydrated at app start from [com.github.jvsena42.echo.data.storage.SecureSessionStore]
 * and updated by [com.github.jvsena42.echo.data.repository.impl.IdentityRepositoryImpl] on sign-in / sign-out.
 */
