 ...
 * the caller supplies `now` (see `com.github.jvsena42.echo.util.epochMillis`). Business logic for
 ...
 * (`design/main/phone-echo.pen` → SRSRow): Again `<10m` / Hard `1d` / Good `3d` / Easy `7d`.
 */
